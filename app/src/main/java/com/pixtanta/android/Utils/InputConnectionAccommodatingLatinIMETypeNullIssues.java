 ...
 *
 */
public class InputConnectionAccommodatingLatinIMETypeNullIssues extends BaseInputConnection {
    ...
    //Basic constructor
    public InputConnectionAccommodatingLatinIMETypeNullIssues(View targetView, boolean fullEditor) {
    ...
    public Editable getEditable() {
        ...
        if(myEditable == null) {
            myEditable = new EditableAccommodatingLatinIMETypeNullIssues(
                    EditableAccommodatingLatinIMETypeNullIssues.ONE_UNPROCESSED_CHARACTER);
