...
public class VisualizerView extends View {
    ...
    private static final int LINE_SCALE = 750; // scales visualizer lines
    ...
    public VisualizerView(Context context, AttributeSet attrs) {
        ...
        linePaint.setColor(getResources().getColor(color)); // set color to green
    ...
    public void onDraw(Canvas canvas) {
        ...
        for (float power : amplitudes) {
            ...
            //canvas.drawRect(curX, 0, curX+1, stopY, linePaint);
        }
    }
}
