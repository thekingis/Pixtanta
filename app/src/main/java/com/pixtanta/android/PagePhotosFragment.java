 ...
 */
public class PagePhotosFragment extends Fragment {

    GridView gridView;
    LinearLayout layout;
    ImageAdaptor imageAdaptor;
    Context cntxt;
    ArrayList<String> files = new ArrayList<>(), selectedDatas = new ArrayList<>(), loadedArr = new ArrayList<>(), photosArr = new ArrayList<>();
    boolean loadingPost = false, allLoaded = false, firstLoad = true, loadedPhotos;
    int imgW, gridViewPos, pageId, width;

    public PagePhotosFragment(ContextData contextData) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        int w = width - 5;
        imgW = (w / 3) - 10;
        View view = inflater.inflate(R.layout.fragment_page_photos, container, false);
