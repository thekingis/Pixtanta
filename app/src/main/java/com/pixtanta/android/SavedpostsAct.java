...
public class SavedpostsAct extends ThemeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            optionsIcons.put("copyLink", R.drawable.ic_copy_link);
            optionsIcons.put("unsavePost", R.drawable.ic_save_post);
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            scrllVw.setOnScrollChangeListener((scrllVw, scrollX, scrollY, oldScrollX, oldScrollY) -> {
                ...
                if(scrollY > scrollH && !loadingPost && !allLoaded){
                    ...
                    progressBar.post(this::getSavedPosts);
                }
            });
        }
                ...
                if (response.isSuccessful()) {
                    ...
                    if(firstLoad) {
                        ...
                        if(dataArr.length() == 0) {
                            ...
                            String text = "You have no Saved Post";
                    ...
                    if(dataArr.length() > 0) {
                        for (int p = 0; p < dataArr.length(); p++) {
                            ...
                            LinearLayout postView = (LinearLayout) getLayoutInflater().inflate(R.layout.saved_posts, null);
    ...
    public void displayOptions() throws JSONException {
        ...
        optionsObj.put("copyLink", "Copy Post Link");
        optionsObj.put("unsavePost", "Unsave Post");
    ...
    private void executeOption(String key) throws JSONException {
        ...
        switch (key){
            case "viewPost":
                ...
                break;
            case "copyLink":
                CharSequence copyLink = Constants.postLinkUrl + activePostId;
    ...
    public void unsavePost() throws JSONException {
        ...
        txter.setText("Are you sure you want to unsave this post?");
